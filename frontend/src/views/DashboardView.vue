    ...
    <main class="dashboard-main">
      <div class="container">
        <section class="welcome-section fade-in">
          ...
          <p>Select a world to manage your winter sports simulation</p>
        </section>
        ...
        <section class="worlds-section">
          ...
          <div v-else-if="worlds.length === 0" class="empty-state fade-in">
            ...
            <h2>No Worlds Yet</h2>
            <p>Create your first simulation world to get started!</p>
            <button @click="showCreateModal = true" class="btn btn-primary">
              <i class="fa-solid fa-plus"></i>
            ...
            >
              ...
              <div class="world-stats">
                <div class="stat">
                  ...
                  <span>{{ world.sports_count }} sports</span>
                </div>
                <div class="stat">
                  <i class="fa-solid fa-users"></i>
                  <span>{{ world.athletes_count }} athletes</span>
                </div>
              </div>
...
const worlds = computed(() => worldsStore.worlds)
...
async function handleCreateWorld() {
  ...
  try {
    const world = await worldsStore.createWorld(newWorld.value.name, newWorld.value.description)
...
async function handleDeleteWorld() {
  ...
  deleting.value = true
  try {
    await worldsStore.deleteWorld(worldToDelete.value.id)
