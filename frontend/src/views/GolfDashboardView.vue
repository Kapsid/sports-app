    ...
    <header class="dashboard-header">
      <div class="container header-content">
        <div class="brand">
          ...
          <i class="fa-solid fa-golf-ball-tee golf-icon"></i>
          <span>Golf</span>
        </div>
        <div class="user-menu">
          <span class="username">
    ...
    <main class="dashboard-main">
      <div class="container">
        <section class="welcome-section fade-in">
          <h1>Golf</h1>
          <p>Manage your PGA Tour worlds and championships</p>
        </section>
        ...
        <section class="worlds-section">
          <div class="section-header">
            ...
            <button @click="showCreateModal = true" class="btn btn-primary golf-btn">
          ...
          <div v-else-if="worlds.length === 0" class="empty-state fade-in">
            ...
            <h2>No Golf Worlds Yet</h2>
            <p>Create your first golf world to start managing golfers and tournaments!</p>
            <button @click="showCreateModal = true" class="btn btn-primary golf-btn">
              <i class="fa-solid fa-plus"></i>
          ...
          <div v-else class="worlds-grid">
            ...
            >
              <div class="world-card-header">
                <div class="world-icon golf-gradient">
                  <i class="fa-solid fa-golf-ball-tee"></i>
                </div>
                <button
              ...
              <div class="world-stats">
                <div class="stat">
                  ...
                  <span>{{ world.players_count || 0 }} golfers</span>
                </div>
                <div class="stat">
              ...
              <div class="world-action golf-action">
        ...
        <form @submit.prevent="handleCreateWorld">
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              placeholder="Describe your golf world..."
              rows="3"
            ></textarea>
          </div>
          ...
          <div class="modal-actions">
            ...
            <button type="submit" class="btn btn-primary golf-btn" :disabled="creating">
    ...
    <div v-if="worldToDelete" class="modal-overlay" @click.self="worldToDelete = null">
      <div class="modal fade-in">
        ...
        <p class="delete-warning">
          ...
          All golfers, seasons, and tournament data will be permanently deleted.
        </p>
        <div class="modal-actions">
...
const worlds = computed(() => golfStore.worlds)
...
function enterWorld(worldId) {
  router.push(`/golf/world/${worldId}`)
}
...
async function handleCreateWorld() {
  ...
  try {
    const world = await golfStore.createWorld(newWorld.value.name, newWorld.value.description)
    showCreateModal.value = false
    newWorld.value = { name: '', description: '' }
    router.push(`/golf/world/${world.id}`)
  } catch (err) {
...
async function handleDeleteWorld() {
  ...
  deleting.value = true
  try {
    await golfStore.deleteWorld(worldToDelete.value.id)
...
onMounted(async () => {
  try {
    await golfStore.fetchWorlds()
  } catch (error) {
    console.error('Failed to load golf worlds:', error)
  } finally {
    loading.value = false
  }
})
