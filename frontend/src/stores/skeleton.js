...
export const useSkeletonStore = defineStore('skeleton', () => {
  ...
  async function fetchAthletes(worldId) {
    ...
    error.value = null
    try {
      const response = await api.get(`/skeleton/world/${worldId}/athletes`)
  ...
  async function createAthlete(worldId, athleteData) {
    ...
    error.value = null
    try {
      const response = await api.post(`/skeleton/world/${worldId}/athlete`, athleteData)
  ...
  async function updateAthlete(athleteId, athleteData) {
    ...
    error.value = null
    try {
      const response = await api.put(`/skeleton/athlete/${athleteId}`, athleteData)
  ...
  async function deleteAthlete(athleteId) {
    ...
    error.value = null
    try {
      await api.delete(`/skeleton/athlete/${athleteId}`)
  ...
  async function deleteAllAthletes(worldId) {
    ...
    error.value = null
    try {
      await api.delete(`/skeleton/world/${worldId}/all-athletes`)
      athletes.value = []
    } catch (err) {
  ...
  async function fetchCurrentSeason(worldId) {
    ...
    error.value = null
    try {
      const response = await api.get(`/skeleton/world/${worldId}/current-season`)
  ...
  async function createSeason(worldId) {
    ...
    error.value = null
    try {
      const response = await api.post(`/skeleton/world/${worldId}/create-season`)
      currentSeason.value = response.data.season
      events.value = response.data.events || []
      standings.value = response.data.standings || []
      return response.data
  ...
  async function fetchEvent(eventId) {
    ...
    error.value = null
    try {
      const response = await api.get(`/skeleton/event/${eventId}`)
  ...
  async function simulateRace(eventId, results = null) {
    ...
    error.value = null
    try {
      const response = await api.post(`/skeleton/event/${eventId}/simulate`, { results })
  ...
  async function simulateRun2(eventId, results = null) {
    ...
    error.value = null
    try {
      const response = await api.post(`/skeleton/event/${eventId}/simulate-run2`, { results })
  ...
  async function simulateRun3(eventId, results = null) {
    ...
    error.value = null
    try {
      const response = await api.post(`/skeleton/event/${eventId}/simulate-run3`, { results })
  ...
  async function simulateRun4(eventId, results = null) {
    ...
    error.value = null
    try {
      const response = await api.post(`/skeleton/event/${eventId}/simulate-run4`, { results })
  ...
  async function resetSeason(seasonId) {
    ...
    error.value = null
    try {
      const response = await api.post(`/skeleton/season/${seasonId}/reset`)
      currentSeason.value = response.data.season
      events.value = response.data.events || []
      standings.value = response.data.standings || []
      return response.data
